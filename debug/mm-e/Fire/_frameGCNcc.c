/*
    ...
    Language: C++
    Code range: 0x8009AD2C -> 0x8009B634
*/
...
// size = 0x40, address = 0x800E8408
static enum _GXTevStageID ganNameTevStage[16];

// size = 0x5, address = 0x8012FA68
static u8 sOrder[5];
...
} __anon_0x8CE93; // size = 0x14

// size = 0x64, address = 0x800E8448
static struct TevColorOp sTevColorOp[5];

// size = 0x5, address = 0x8012FA70
static u8 sReplace[5];

// size = 0x50, address = 0x800E84AC
static enum _GXTevColorArg sTevColorArg[5][4];

// size = 0x50, address = 0x800E84FC
static enum _GXTevAlphaArg sTevAlphaArg[5][4];

// size = 0x40, address = 0x800E85E0
static char* sColorNames[16];

// size = 0x40, address = 0x800E8620
static char* sAlphaNames[2][8];

// size = 0x40, address = 0x800E8660
static char* strings$289[4][4];

typedef enum __anon_0x8D4B9 {
    SM_NONE = -1,
    SM_RUNNING = 0,
    SM_STOPPED = 1,
} __anon_0x8D4B9;

typedef struct __anon_0x8D524 {
    /* 0x0 */ s32 nSize;
    /* 0x4 */ s32 nOffsetRAM;
    /* 0x8 */ s32 nOffsetROM;
    /* 0xC */ s32 (* pCallback)();
} __anon_0x8D524; // size = 0x10

typedef enum __anon_0x8D5D5 {
    SRT_NONE = -1,
    SRT_MARIO = 0,
    SRT_WAVERACE = 1,
    SRT_MARIOKART = 2,
...
typedef struct __anon_0x8D87E {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x8D4B9 eMode;
    /* 0x10 */ struct __anon_0x8D524 romCopy;
    /* 0x20 */ enum __anon_0x8D5D5 eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x8D73B storageDevice;
    /* 0x74 */ u8 anException[16];
} __anon_0x8D87E; // size = 0x88

// size = 0x4, address = 0x8012FD48
struct __anon_0x8D87E* gpSystem;

typedef struct __anon_0x8DA82 {
    /* 0x0 */ f32 rX;
    /* 0x4 */ f32 rY;
    /* 0x8 */ f32 rSizeX;
    /* 0xC */ f32 rSizeY;
} __anon_0x8DA82; // size = 0x10

typedef struct __anon_0x8DB1C {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nWidth;
    /* 0x08 */ s32 nFormat;
    /* 0x0C */ void* pData;
    /* 0x10 */ s32 nAddress;
} __anon_0x8DB1C; // size = 0x14

typedef struct __anon_0x8DC5D {
    /* 0x0 */ f32 x;
    /* 0x4 */ f32 y;
    /* 0x8 */ f32 z;
} __anon_0x8DC5D; // size = 0xC

typedef struct __anon_0x8DCCD {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x8DC5D rVecOrigTowards;
    /* 0x10 */ f32 rColorR;
    /* 0x14 */ f32 rColorG;
    /* 0x18 */ f32 rColorB;
    /* 0x1C */ f32 rVectorX;
    ...
    /* 0x36 */ s16 coordY;
    /* 0x38 */ s16 coordZ;
} __anon_0x8DCCD; // size = 0x3C

typedef struct __anon_0x8DEFD {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x8DC5D rS;
    /* 0x10 */ struct __anon_0x8DC5D rT;
    /* 0x1C */ struct __anon_0x8DC5D rSRaw;
    /* 0x28 */ struct __anon_0x8DC5D rTRaw;
} __anon_0x8DEFD; // size = 0x34

typedef struct __anon_0x8DFE6 {
    /* 0x00 */ f32 rSum;
    /* 0x04 */ f32 rS;
    /* 0x08 */ f32 rT;
    /* 0x0C */ struct __anon_0x8DC5D vec;
    /* 0x18 */ u8 anColor[4];
} __anon_0x8DFE6; // size = 0x1C

typedef union __anon_0x8E145 {
    /* 0x0 */ u8 u8[4096];
    /* 0x0 */ u16 u16[2048];
    /* 0x0 */ u32 u32[1024];
    /* 0x0 */ u64 u64[512];
...
typedef struct __anon_0x8E1E2 {
    /* 0x0 */ union __anon_0x8E145 data;
} __anon_0x8E1E2; // size = 0x1000
...
typedef struct _GXTlutObj {
    /* 0x0 */ u32 dummy[3];
} __anon_0x8E43D; // size = 0xC

typedef struct _GXTexObj {
    /* 0x0 */ u32 dummy[8];
} __anon_0x8E4A4; // size = 0x20
...
} __anon_0x8E553; // size = 0x6C

typedef struct __anon_0x8E8B0 {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nTMEM;
    /* 0x08 */ s32 iTLUT;
    /* 0x0C */ s32 nSizeX;
    ...
    /* 0x26 */ s16 nY1;
    /* 0x28 */ u32 nCodePixel;
} __anon_0x8E8B0; // size = 0x2C

typedef enum __anon_0x8EB92 {
    FMP_NONE = -1,
    FMP_PERSPECTIVE = 0,
    FMP_ORTHOGRAPHIC = 1,
} __anon_0x8EB92;

typedef struct __anon_0x8EC1B {
    /* 0x00 */ s32 nCount;
    /* 0x04 */ f32 rScale;
    /* 0x08 */ f32 rAspect;
    ...
    /* 0x20 */ enum __anon_0x8EB92 eProjection;
} __anon_0x8EC1B; // size = 0x24

typedef struct __anon_0x8EDD2 {
    ...
    /* 0x000A8 */ struct __anon_0x8DA82 viewport;
    /* 0x000B8 */ struct __anon_0x8DB1C aBuffer[4];
    ...
    /* 0x00130 */ struct __anon_0x8DCCD aLight[8];
    /* 0x00310 */ struct __anon_0x8DEFD lookAt;
    /* 0x00344 */ s32 nCountVertex;
    /* 0x00348 */ struct __anon_0x8DFE6 aVertex[80];
    /* 0x00C08 */ struct __anon_0x8E1E2 TMEM;
    ...
    /* 0x3C340 */ s32 nLastX1;
    /* 0x3C344 */ s32 nLastY1;
    /* 0x3C348 */ struct __anon_0x8E8B0 aTile[8];
...
} __anon_0x8FF81; // size = 0x2B8

// size = 0x0, address = 0x800E1E08
enum _GXTexCoordID ganNameTexCoord[];

// size = 0x0, address = 0x800E1DC8
...
typedef struct _GXColor {
    ...
    /* 0x2 */ u8 b;
    /* 0x3 */ u8 a;
} __anon_0x90AFA; // size = 0x4

// Range: 0x8009B330 -> 0x8009B634
static void SetTableTevStages(struct __anon_0x8EDD2* pFrame, struct CombineModeTev* ctP) {
    // Parameters
    // struct __anon_0x8EDD2* pFrame; // r30
...
// Erased
static void CheckNewCCMode(struct __anon_0x8EDD2* pFrame, s32 numCycles) {
    // Parameters
    // struct __anon_0x8EDD2* pFrame; // r1+0x8
    // s32 numCycles; // r29
...
// Range: 0x8009B170 -> 0x8009B330
void SetNumTexGensChans(struct __anon_0x8EDD2* pFrame, s32 numCycles) {
    // Parameters
    // struct __anon_0x8EDD2* pFrame; // r1+0x8
...
// Range: 0x8009ADEC -> 0x8009B170
void SetTevStages(struct __anon_0x8EDD2* pFrame, s32 cycle) {
    // Parameters
    // struct __anon_0x8EDD2* pFrame; // r1+0x8
    // s32 cycle; // r17
...
// Range: 0x8009AD2C -> 0x8009ADEC
s32 SetTevStageTable(struct __anon_0x8EDD2* pFrame, s32 numCycles) {
    // Parameters
    // struct __anon_0x8EDD2* pFrame; // r31
    // s32 numCycles; // r7
