/*
    ...
    Language: C89
    Code range: 0x80036A44 -> 0x800685C4
*/
...
s32 cpuMakeFunction(struct _CPU* pCPU, struct cpu_function** ppFunction, s32 nAddressN64) {
    ...
    struct __anon_0x42875 aJump[1024]; // r1+0x18
...
static s32 cpuExecuteUpdate(struct _CPU* pCPU, s32* pnAddressGCN, u32 nCount) {
    ...
    // Local variables
    enum __anon_0x4938F eModeUpdate; // r4
    struct __anon_0x4253E* pSystem; // r31
    s32 nDelta; // r1+0x8
    u32 nCounter; // r1+0x8
    u32 nCompare; // r1+0x8
...
static s32 cpuExecuteOpcode(struct _CPU* pCPU, s32 nCount, s32 nAddressN64, s32 nAddressGCN) {
    ...
    u32 nOpcode; // r30
    u32* opcode; // r1+0x6C
    struct __anon_0x4354C** apDevice; // r28
    u8* aiDevice; // r29
    s32 reg; // r1+0x8
    s32 value; // r3
    s32 iEntry; // r4
...
static s32 cpuExecuteIdle(struct _CPU* pCPU, s32 nCount, s32 nAddressN64, s32 nAddressGCN) {
    ...
    // Local variables
    struct __anon_0x48EE4* pROM; // r30
}

// Range: 0x8003958C -> 0x8003965C
