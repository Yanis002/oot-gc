/*
    ...
    Language: C++
    Code range: 0x8002C374 -> 0x80030F70
*/
...
} __anon_0x38E12; // size = 0x174

// size = 0x174, address = 0x8012A530
struct __anon_0x38E12 gSystemRomConfigurationList[1];

typedef struct __anon_0x38FDC {
    /* 0x0 */ f32 rX;
    /* 0x4 */ f32 rY;
    /* 0x8 */ f32 rSizeX;
    /* 0xC */ f32 rSizeY;
} __anon_0x38FDC; // size = 0x10

typedef struct __anon_0x39076 {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nWidth;
    /* 0x08 */ s32 nFormat;
    /* 0x0C */ void* pData;
    /* 0x10 */ s32 nAddress;
} __anon_0x39076; // size = 0x14

typedef struct __anon_0x391B7 {
    /* 0x0 */ f32 x;
    /* 0x4 */ f32 y;
    /* 0x8 */ f32 z;
} __anon_0x391B7; // size = 0xC

typedef struct __anon_0x39227 {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x391B7 rVecOrigTowards;
    /* 0x10 */ f32 rColorR;
    /* 0x14 */ f32 rColorG;
    /* 0x18 */ f32 rColorB;
    /* 0x1C */ f32 rVectorX;
    ...
    /* 0x36 */ s16 coordY;
    /* 0x38 */ s16 coordZ;
} __anon_0x39227; // size = 0x3C

typedef struct __anon_0x39457 {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x391B7 rS;
    /* 0x10 */ struct __anon_0x391B7 rT;
    /* 0x1C */ struct __anon_0x391B7 rSRaw;
    /* 0x28 */ struct __anon_0x391B7 rTRaw;
} __anon_0x39457; // size = 0x34

typedef struct __anon_0x39540 {
    /* 0x00 */ f32 rSum;
    /* 0x04 */ f32 rS;
    /* 0x08 */ f32 rT;
    /* 0x0C */ struct __anon_0x391B7 vec;
    /* 0x18 */ u8 anColor[4];
} __anon_0x39540; // size = 0x1C

typedef union __anon_0x3969F {
    /* 0x0 */ u8 u8[4096];
    /* 0x0 */ u16 u16[2048];
    /* 0x0 */ u32 u32[1024];
    /* 0x0 */ u64 u64[512];
...
typedef struct __anon_0x3973C {
    /* 0x0 */ union __anon_0x3969F data;
} __anon_0x3973C; // size = 0x1000
...
typedef struct _GXTlutObj {
    /* 0x0 */ u32 dummy[3];
} __anon_0x39997; // size = 0xC

typedef struct _GXTexObj {
    /* 0x0 */ u32 dummy[8];
} __anon_0x399FE; // size = 0x20
...
} __anon_0x39AAD; // size = 0x6C

typedef struct __anon_0x39E0A {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nTMEM;
    /* 0x08 */ s32 iTLUT;
    /* 0x0C */ s32 nSizeX;
    ...
    /* 0x26 */ s16 nY1;
    /* 0x28 */ u32 nCodePixel;
} __anon_0x39E0A; // size = 0x2C

typedef enum __anon_0x3A0EC {
    FMP_NONE = -1,
    FMP_PERSPECTIVE = 0,
    FMP_ORTHOGRAPHIC = 1,
} __anon_0x3A0EC;

typedef struct __anon_0x3A170 {
    /* 0x00 */ s32 nCount;
    /* 0x04 */ f32 rScale;
    /* 0x08 */ f32 rAspect;
    ...
    /* 0x20 */ enum __anon_0x3A0EC eProjection;
} __anon_0x3A170; // size = 0x24
...
typedef struct _GXColor {
    ...
    /* 0x2 */ u8 b;
    /* 0x3 */ u8 a;
} __anon_0x3A305; // size = 0x4

typedef struct __anon_0x3A3C0 {
    ...
    /* 0x000A8 */ struct __anon_0x38FDC viewport;
    /* 0x000B8 */ struct __anon_0x39076 aBuffer[4];
    ...
    /* 0x00130 */ struct __anon_0x39227 aLight[8];
    /* 0x00310 */ struct __anon_0x39457 lookAt;
    /* 0x00344 */ s32 nCountVertex;
    /* 0x00348 */ struct __anon_0x39540 aVertex[80];
    /* 0x00C08 */ struct __anon_0x3973C TMEM;
    ...
    /* 0x3C340 */ s32 nLastX1;
    /* 0x3C344 */ s32 nLastY1;
    /* 0x3C348 */ struct __anon_0x39E0A aTile[8];
...
} __anon_0x3A3C0; // size = 0x3D138

// size = 0x4, address = 0x8012FD50
struct __anon_0x3A3C0* gpFrame;

typedef enum __anon_0x3B1E0 {
    SPM_NONE = -1,
    SPM_PLAY = 0,
    SPM_RAMPQUEUED = 1,
    SPM_RAMPPLAYED = 2,
...
typedef struct __anon_0x3B24C {
    ...
    /* 0xB4 */ enum __anon_0x3B1E0 eMode;
    ...
    /* 0xD0 */ s32 nSizeHold;
    /* 0xD4 */ s32 nSizeRamp;
} __anon_0x3B24C; // size = 0xD8

// size = 0x4, address = 0x8012FD4C
struct __anon_0x3B24C* gpSound;
...
// size = 0x10, address = 0x800E820C
struct _XL_OBJECTTYPE gClassPeripheral;

// size = 0x10, address = 0x800E64C8
struct _XL_OBJECTTYPE gClassRdb;

typedef struct __anon_0x3B7E2 {
    /* 0x0 */ s32 nSize;
    /* 0x4 */ s32 nOffsetRAM;
    /* 0x8 */ s32 nOffsetROM;
    /* 0xC */ s32 (* pCallback)();
} __anon_0x3B7E2; // size = 0x10

typedef enum __anon_0x3B893 {
    SRT_NONE = -1,
    SRT_MARIO = 0,
    SRT_WAVERACE = 1,
    SRT_MARIOKART = 2,
...
typedef struct __anon_0x3BA14 {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x3E82C eMode;
    /* 0x10 */ struct __anon_0x3B7E2 romCopy;
    /* 0x20 */ enum __anon_0x3B893 eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x3DC74 storageDevice;
    /* 0x74 */ u8 anException[16];
} __anon_0x3BA14; // size = 0x88

typedef struct __anon_0x3BBAF {
    /* 0x0 */ s32 nOffsetHost;
    /* 0x4 */ s32 nAddressN64;
} __anon_0x3BBAF; // size = 0x8

typedef struct cpu_callerID {
    /* 0x0 */ s32 N64address;
    /* 0x4 */ s32 GCNaddress;
} __anon_0x3BC15; // size = 0x8

typedef struct cpu_function {
    /* 0x00 */ void* pnBase;
    /* 0x04 */ void* pfCode;
    /* 0x08 */ s32 nCountJump;
    /* 0x0C */ struct __anon_0x3BBAF* aJump;
    /* 0x10 */ s32 nAddress0;
    /* 0x14 */ s32 nAddress1;
...
} __anon_0x3BC88; // size = 0x48

typedef union __anon_0x3BF64 {
    /* 0x0 */ char _0s8;
    /* 0x1 */ char _1s8;
    /* 0x2 */ char _2s8;
    /* 0x3 */ char _3s8;
...
} __anon_0x3CB54; // size = 0x84

typedef struct _CPU_ADDRESS {
    /* 0x0 */ s32 nN64;
    /* 0x4 */ s32 nHost;
    /* 0x8 */ struct cpu_function* pFunction;
} __anon_0x3CD95; // size = 0xC

typedef struct __anon_0x3CE4A {
    /* 0x0 */ u32 nAddress;
    /* 0x4 */ u32 nOpcodeOld;
    /* 0x8 */ u32 nOpcodeNew;
} __anon_0x3CE4A; // size = 0xC
...
typedef struct _CPU {
    ...
    /* 0x00040 */ union __anon_0x3BF64 aGPR[32];
    /* 0x00140 */ union __anon_0x3C378 aFPR[32];
    ...
    /* 0x00B64 */ struct __anon_0x3C886* apDevice[256];
    ...
    /* 0x11EA8 */ struct __anon_0x3CE4A aCodeHack[32];
...
} __anon_0x3D494; // size = 0x12090

typedef enum __anon_0x3DB2B {
    MIT_NONE = -1,
    MIT_SP = 0,
    MIT_SI = 1,
    MIT_AI = 2,
...
typedef struct __anon_0x3DBA6 {
    /* 0x00 */ char* szType;
    /* 0x04 */ u32 nMask;
    /* 0x08 */ enum __anon_0x3E0F2 eCode;
    /* 0x0C */ enum __anon_0x3DF43 eType;
    /* 0x10 */ enum __anon_0x3DB2B eTypeMips;
} __anon_0x3DBA6; // size = 0x14

typedef enum __anon_0x3DC74 {
    SOT_NONE = -1,
    SOT_CPU = 0,
    SOT_PIF = 1,
    SOT_RAM = 2,
...
struct __anon_0x3BA14* gpSystem;

// size = 0x1, address = 0x8012FCF4
u8 gLanguage;

typedef struct __anon_0x3EFD4 {
...
typedef struct CARDFileInfo {
    ...
    /* 0x10 */ u16 iBlock;
    /* 0x12 */ u16 __padding;
} __anon_0x3F2E5; // size = 0x14

typedef struct __anon_0x3F3DD {
    /* 0x000 */ s32 currentGame;
    /* 0x004 */ s32 fileSize;
    /* 0x008 */ char name[33];
    /* 0x02C */ s32 numberOfGames;
    /* 0x030 */ struct __anon_0x3EFD4 game;
...
} __anon_0x3F3DD; // size = 0x35C

typedef enum __anon_0x3F5F3 {
    MC_E_NONE = 0,
    MC_E_BUSY = 1,
    MC_E_WRONGDEVICE = 2,
    MC_E_NOCARD = 3,
...
typedef struct _MCARD {
    /* 0x000 */ struct __anon_0x3F3DD file;
    /* 0x35C */ enum __anon_0x3F5F3 error;
    /* 0x360 */ s32 slot;
...
} __anon_0x401DC; // size = 0x3C

typedef enum __anon_0x402B4 {
    RLM_NONE = -1,
    RLM_PART = 0,
    RLM_FULL = 1,
    RLM_COUNT_ = 2,
...
typedef struct __anon_0x40316 {
    /* 0x0 */ s32 iCache;
    /* 0x4 */ u32 nSize;
    /* 0x8 */ u32 nTickUsed;
    /* 0xC */ char keep;
} __anon_0x40316; // size = 0x10

typedef struct __anon_0x4042A {
    /* 0x00 */ s32 bWait;
    /* 0x04 */ s32 (* pCallback)();
    /* 0x08 */ u8* pTarget;
    /* 0x0C */ u32 nSize;
    /* 0x10 */ u32 nOffset;
} __anon_0x4042A; // size = 0x14

typedef struct __anon_0x4050A {
    /* 0x00 */ s32 bWait;
    /* 0x04 */ s32 bDone;
    /* 0x08 */ s32 nResult;
    /* 0x0C */ u8* anData;
    ...
    /* 0x28 */ u32 nSize;
    /* 0x2C */ u32 nSizeRead;
} __anon_0x4050A; // size = 0x30

typedef struct __anon_0x406F5 {
    /* 0x0 */ s32 nPosition;
    /* 0x4 */ s32 nLineNumber;
} __anon_0x406F5; // size = 0x8

typedef struct __anon_0x40759 {
    /* 0x0 */ s32 nMode;
    /* 0x4 */ s32 nModeSave;
    /* 0x8 */ struct __anon_0x406F5 save;
} __anon_0x40759; // size = 0x10

typedef struct __anon_0x407DA {
    /* 0x00000 */ void* pHost;
    ...
    /* 0x00214 */ u32 nSize;
    /* 0x00218 */ enum __anon_0x402B4 eModeLoad;
    /* 0x0021C */ struct __anon_0x40316 aBlock[4096];
    /* 0x1021C */ u32 nTick;
    /* 0x10220 */ u8* pCacheRAM;
    /* 0x10224 */ u8 anBlockCachedRAM[1024];
    /* 0x10624 */ u8 anBlockCachedARAM[2046];
    /* 0x10E24 */ struct __anon_0x4042A copy;
    /* 0x10E38 */ struct __anon_0x4050A load;
    ...
    /* 0x10EB8 */ struct __anon_0x40759 tagFile;
    /* 0x10EC8 */ u32 nChecksum;
    /* 0x10ECC */ struct DVDFileInfo fileInfo;
    /* 0x10F08 */ s32 offsetToRom;
} __anon_0x407DA; // size = 0x10F0C

typedef enum __anon_0x40BB5 {
    CT_NONE = 0,
    CT_CONTROLLER = 1,
...
typedef struct __anon_0x40C8E {
    /* 0x00 */ void* pROM;
    /* 0x04 */ void* pRAM;
    /* 0x08 */ void* pHost;
    /* 0x0C */ u16 controllerType[5];
    /* 0x16 */ char controllerStatus[5];
    /* 0x1C */ enum __anon_0x40BB5 eControllerType[5];
} __anon_0x40C8E; // size = 0x30

// Range: 0x80030B34 -> 0x80030F70
static s32 systemSetupGameRAM(struct __anon_0x3BA14* pSystem) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r27
    ...
    s32 nSizeExtra; // r3
    struct __anon_0x407DA* pROM; // r29
    u32 nCode; // r28
    u32 iCode; // r1+0x8
...
// Range: 0x800301B0 -> 0x80030B34
s32 systemGetInitialConfiguration(struct __anon_0x407DA* pROM, s32 index) {
    // Parameters
    // struct __anon_0x407DA* pROM; // r23
    // s32 index; // r1+0x10
...
// Range: 0x8002D6CC -> 0x800301B0
static s32 systemSetupGameALL(struct __anon_0x3BA14* pSystem) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r18
    ...
    struct __anon_0x407DA* pROM; // r19
    struct __anon_0x40C8E* pPIF; // r27
...
// Erased
static s32 systemClearExceptions(struct __anon_0x3BA14* pSystem) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r1+0x0

    // Local variables
    s32 iException; // r1+0x0
}

// Range: 0x8002D4F0 -> 0x8002D6CC
static s32 systemGetException(enum __anon_0x3DF43 eType, struct __anon_0x3DBA6* pException) {
    // Parameters
    // enum __anon_0x3DF43 eType; // r1+0x4
    // struct __anon_0x3DBA6* pException; // r1+0x8
}

// Range: 0x8002D4E0 -> 0x8002D4F0
static s32 systemGet8(char* pData) {
    // Parameters
    // char* pData; // r1+0x8
}

// Range: 0x8002D4D0 -> 0x8002D4E0
static s32 systemGet16(s16* pData) {
    // Parameters
    // s16* pData; // r1+0x8
}

// Range: 0x8002D4C0 -> 0x8002D4D0
static s32 systemGet32(s32* pData) {
    // Parameters
    // s32* pData; // r1+0x8
}

// Range: 0x8002D4AC -> 0x8002D4C0
static s32 systemGet64(s64* pData) {
    // Parameters
    // s64* pData; // r1+0x8
}

// Range: 0x8002D4A4 -> 0x8002D4AC
static s32 systemPut8() {}

// Range: 0x8002D49C -> 0x8002D4A4
static s32 systemPut16() {}

// Range: 0x8002D494 -> 0x8002D49C
static s32 systemPut32() {}

// Range: 0x8002D48C -> 0x8002D494
static s32 systemPut64() {}

// Range: 0x8002D354 -> 0x8002D48C
...
// Range: 0x8002D260 -> 0x8002D354
s32 systemCopyROM(struct __anon_0x3BA14* pSystem, s32 nOffsetRAM, s32 nOffsetROM, s32 nSize, s32 (* pCallback)()) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r29
    // s32 nOffsetRAM; // r4
    // s32 nOffsetROM; // r30
    // s32 nSize; // r1+0x14
    // s32 (* pCallback)(); // r31
...
// Erased
static s32 systemSetBreak(struct __anon_0x3BA14* pSystem, s64 nAddress) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r1+0x0
    // s64 nAddress; // r1+0x8
}
...
// Erased
static s32 systemClearBreak(struct __anon_0x3BA14* pSystem) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r1+0x0
}

// Range: 0x8002D1F0 -> 0x8002D260
s32 systemSetMode(struct __anon_0x3BA14* pSystem, enum __anon_0x3E82C eMode) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r30
    // enum __anon_0x3E82C eMode; // r31

    // References
    // -> struct _XL_OBJECTTYPE gClassSystem;
}

// Range: 0x8002D188 -> 0x8002D1F0
s32 systemGetMode(struct __anon_0x3BA14* pSystem, enum __anon_0x3E82C* peMode) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r30
    // enum __anon_0x3E82C* peMode; // r31

    // References
    // -> struct _XL_OBJECTTYPE gClassSystem;
}

// Range: 0x8002D09C -> 0x8002D188
s32 systemSetStorageDevice(struct __anon_0x3BA14* pSystem, enum __anon_0x3DC74 storageDevice) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r30
    // enum __anon_0x3DC74 storageDevice; // r31
...
// Range: 0x8002D08C -> 0x8002D09C
s32 systemGetStorageDevice(struct __anon_0x3BA14* pSystem, enum __anon_0x3DC74* pStorageDevice) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r1+0x0
    // enum __anon_0x3DC74* pStorageDevice; // r1+0x4
}

// Range: 0x8002CED4 -> 0x8002D08C
s32 systemReset(struct __anon_0x3BA14* pSystem) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r29
    ...
    s64 nPC; // r1+0x10
    s32 nOffsetRAM; // r4
    enum __anon_0x3DC74 eObject; // r30
}

// Range: 0x8002CDD8 -> 0x8002CED4
s32 systemExecute(struct __anon_0x3BA14* pSystem, s32 nCount) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r31
    // s32 nCount; // r4
...
// Range: 0x8002CC80 -> 0x8002CDD8
s32 systemCheckInterrupts(struct __anon_0x3BA14* pSystem) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r25
    ...
    s32 bUsed; // r28
    s32 bDone; // r27
    struct __anon_0x3DBA6 exception; // r1+0xC
    enum __anon_0x3E0F2 eCodeFinal; // r26
}

// Range: 0x8002CC48 -> 0x8002CC80
s32 systemExceptionPending(struct __anon_0x3BA14* pSystem, enum __anon_0x3DF43 eType) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r1+0x0
    // enum __anon_0x3DF43 eType; // r1+0x4
}

// Range: 0x8002C374 -> 0x8002CC48
s32 systemEvent(struct __anon_0x3BA14* pSystem, s32 nEvent, void* pArgument) {
    // Parameters
    // struct __anon_0x3BA14* pSystem; // r31
    // s32 nEvent; // r1+0xC
    // void* pArgument; // r26
    ...
    // Local variables
    struct _CPU* pCPU; // r30
    struct __anon_0x3DBA6 exception; // r1+0x1C
    enum __anon_0x3DC74 eObject; // r1+0x8
    enum __anon_0x3DC74 storageDevice; // r1+0x8
