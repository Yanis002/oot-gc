/*
    Compile unit: c:\HOMEBOY\STEPHEN\Emulator\Fire\codeGCN.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8001D000 -> 0x8001D054
*/
...
typedef struct tXL_FILE {
    ...
    /* 0x10 */ s32 nSize;
    /* 0x14 */ s32 nOffset;
    /* 0x18 */ enum __anon_0x23F70 eType;
    /* 0x1C */ s32 iLine;
    /* 0x20 */ s32 nLineNumber;
    /* 0x24 */ struct DVDFileInfo info;
} __anon_0x24476; // size = 0x60

// size = 0x4, address = 0x8012FDD0
static void* gpBufferFunction;

// size = 0x4, address = 0x8012FDD4
