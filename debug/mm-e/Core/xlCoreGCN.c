/*
    ...
    Language: C++
    Code range: 0x800055A0 -> 0x80005BF4
*/

#include "types.h"

// size = 0x8081, address = 0x800D8180
u8 gTgPcTPL[32897];

// size = 0x4, address = 0x8012FCA0
static s32 gnCountArgument;

// size = 0x4, address = 0x8012FCA4
static char** gaszArgument;

// size = 0x4, address = 0x8012FCA8
...
// size = 0x3C, address = 0x800ECBA0
static struct _GXRenderModeObj rmodeobj;

// size = 0x4, address = 0x8012FCB0
static void* gpHeap;

// size = 0x4, address = 0x8012FCB4
static void* gArenaHi;

// size = 0x4, address = 0x8012FCB8
