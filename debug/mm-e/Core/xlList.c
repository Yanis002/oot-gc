/*
    ...
    Language: C++
    Code range: 0x80006088 -> 0x80006450
*/
...
typedef struct tXL_LIST {
    ...
    /* 0x8 */ void* pNodeHead;
    /* 0xC */ void* pNodeNext;
} __anon_0x2E29; // size = 0x10

// size = 0x10, address = 0x800ECC60
...
// Range: 0x80006090 -> 0x800060B8
s32 xlListSetup() {
    // References
    // -> static struct tXL_LIST gListList;
}

// Range: 0x80006088 -> 0x80006090
s32 xlListReset() {}
