/*
    ...
    Language: C++
    Code range: 0x80005C58 -> 0x80005F94
*/
...
} __anon_0x18A8; // size = 0x10

// size = 0x10, address = 0x800E0220
...
} __anon_0x1D8F; // size = 0x3C

// size = 0x4, address = 0x8012FCC0
static s32 (* gpfOpen)(char*, struct DVDFileInfo*);

// size = 0x4, address = 0x8012FCC4
...
typedef struct tXL_FILE {
    ...
    /* 0x10 */ s32 nSize;
    /* 0x14 */ s32 nOffset;
    /* 0x18 */ enum __anon_0x2440 eType;
    /* 0x1C */ s32 iLine;
    /* 0x20 */ s32 nLineNumber;
    /* 0x24 */ struct DVDFileInfo info;
} __anon_0x1F41; // size = 0x60

typedef enum __anon_0x2440 {
    XLFT_NONE = -1,
    XLFT_TEXT = 0,
    XLFT_BINARY = 1,
} __anon_0x2440;

// Range: 0x80005F88 -> 0x80005F94
...
// Range: 0x80005EA8 -> 0x80005F7C
s32 xlFileOpen(struct tXL_FILE** ppFile, enum __anon_0x2440 eType, char* szFileName) {
    // Parameters
    // struct tXL_FILE** ppFile; // r29
    // enum __anon_0x2440 eType; // r30
    // char* szFileName; // r31
