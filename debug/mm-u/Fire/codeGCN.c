/*
    ...
    Language: C++
    Code range: 0x8001C720 -> 0x8001C774
*/
...
typedef struct tXL_FILE {
    ...
    /* 0x10 */ s32 nSize;
    /* 0x14 */ s32 nOffset;
    /* 0x18 */ enum __anon_0x21770 eType;
    /* 0x1C */ s32 iLine;
    /* 0x20 */ s32 nLineNumber;
    /* 0x24 */ struct DVDFileInfo info;
} __anon_0x21C76; // size = 0x60

// size = 0x4, address = 0x80141168
static void* gpBufferFunction;

// size = 0x4, address = 0x8014116C
