/*
    ...
    Language: C++
    Code range: 0x8009BFDC -> 0x8009F3E4
*/
...
} __anon_0x8ECE4; // size = 0x14

// size = 0x50, address = 0x800F9AA0
static struct TevColorOp sUsualOps[4];

// size = 0x10, address = 0x800F9AF0
static enum _GXTevColorArg sUsualCArgs[4];

// size = 0x10, address = 0x800F9B00
static enum _GXTevAlphaArg sUsualAArgs[4];

// size = 0x8, address = 0x80140EC8
static s32 zeroType$182[2];

// size = 0x20, address = 0x800F9B10
static s32 texelType$183[2][4];

// size = 0x10, address = 0x800F9B30
...
} __anon_0x8F3F1; // size = 0x2B8

// size = 0x2B8, address = 0x8013BCE0
static struct CombineModeTev tevStages$519;

typedef enum __anon_0x8FE92 {
    SM_NONE = -1,
    SM_RUNNING = 0,
    SM_STOPPED = 1,
} __anon_0x8FE92;

typedef struct __anon_0x8FEFB {
    /* 0x0 */ s32 nSize;
    /* 0x4 */ s32 nOffsetRAM;
    /* 0x8 */ s32 nOffsetROM;
    /* 0xC */ s32 (* pCallback)();
} __anon_0x8FEFB; // size = 0x10

typedef enum __anon_0x8FFAC {
    SRT_NONE = -1,
    SRT_MARIO = 0,
    SRT_WAVERACE = 1,
    SRT_MARIOKART = 2,
...
typedef struct __anon_0x90251 {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x8FE92 eMode;
    /* 0x10 */ struct __anon_0x8FEFB romCopy;
    /* 0x20 */ enum __anon_0x8FFAC eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x90110 storageDevice;
    /* 0x74 */ u8 anException[16];
    /* 0x84 */ s32 bJapaneseVersion;
} __anon_0x90251; // size = 0x88

// size = 0x4, address = 0x801410E0
struct __anon_0x90251* gpSystem;

// Range: 0x8009F24C -> 0x8009F3E4
