/*
    ...
    Language: C++
    Code range: 0x8009F3E4 -> 0x800A0160
*/

#include "types.h"

// size = 0x4, address = 0x80140ED8
s32 gBGMVolume;

// size = 0x4, address = 0x80140EDC
s32* gDVDVolumeP;

// size = 0x4, address = 0x801412A0
...
} __anon_0x90AD6; // size = 0x3C

// size = 0x3C, address = 0x8013BF98
static struct DVDFileInfo sErrorDFI;

// size = 0x4, address = 0x801412A4
static s32 counter$238;

typedef union __anon_0x90C7E {
    /* 0x0 */ s32 code;
    /* 0x0 */ u8 bytes[4];
} __anon_0x90C7E;
...
typedef struct DVDTrackList {
    ...
    /* 0x8E8 */ union __anon_0x90C7E error;
...
} __anon_0x90ED4; // size = 0x958

// size = 0x958, address = 0x8013BFD4
...
// Range: 0x800A0084 -> 0x800A0088
static void DVDTrackStopCallback() {}

// Range: 0x8009FEA0 -> 0x800A0084
