/*
    ...
    Language: C++
    Code range: 0x8002BA4C -> 0x8003050C
*/

#include "types.h"

// size = 0x4, address = 0x801408D0
u32 nTickMultiplier;

// size = 0x4, address = 0x801408D4
f32 fTickScale;
...
} __anon_0x3660A; // size = 0x174

// size = 0x174, address = 0x8013B910
struct __anon_0x3660A gSystemRomConfigurationList[1];

typedef struct __anon_0x367D4 {
    /* 0x0 */ f32 rX;
    /* 0x4 */ f32 rY;
    /* 0x8 */ f32 rSizeX;
    /* 0xC */ f32 rSizeY;
} __anon_0x367D4; // size = 0x10

typedef struct __anon_0x3686E {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nWidth;
    /* 0x08 */ s32 nFormat;
    /* 0x0C */ void* pData;
    /* 0x10 */ s32 nAddress;
} __anon_0x3686E; // size = 0x14

typedef struct __anon_0x369AF {
    /* 0x0 */ f32 x;
    /* 0x4 */ f32 y;
    /* 0x8 */ f32 z;
} __anon_0x369AF; // size = 0xC

typedef struct __anon_0x36A1F {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x369AF rVecOrigTowards;
    /* 0x10 */ f32 rColorR;
    /* 0x14 */ f32 rColorG;
    /* 0x18 */ f32 rColorB;
    /* 0x1C */ f32 rVectorX;
    ...
    /* 0x36 */ s16 coordY;
    /* 0x38 */ s16 coordZ;
} __anon_0x36A1F; // size = 0x3C

typedef struct __anon_0x36C4F {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x369AF rS;
    /* 0x10 */ struct __anon_0x369AF rT;
    /* 0x1C */ struct __anon_0x369AF rSRaw;
    /* 0x28 */ struct __anon_0x369AF rTRaw;
} __anon_0x36C4F; // size = 0x34

typedef struct __anon_0x36D38 {
    /* 0x00 */ f32 rSum;
    /* 0x04 */ f32 rS;
    /* 0x08 */ f32 rT;
    /* 0x0C */ struct __anon_0x369AF vec;
    /* 0x18 */ u8 anColor[4];
} __anon_0x36D38; // size = 0x1C

typedef union __anon_0x36E97 {
    /* 0x0 */ u8 u8[4096];
    /* 0x0 */ u16 u16[2048];
    /* 0x0 */ u32 u32[1024];
    /* 0x0 */ u64 u64[512];
...
typedef struct __anon_0x36F34 {
    /* 0x0 */ union __anon_0x36E97 data;
} __anon_0x36F34; // size = 0x1000
...
typedef struct _GXTlutObj {
    /* 0x0 */ u32 dummy[3];
} __anon_0x3718F; // size = 0xC

typedef struct _GXTexObj {
    /* 0x0 */ u32 dummy[8];
} __anon_0x371F6; // size = 0x20
...
} __anon_0x372A5; // size = 0x6C

typedef struct __anon_0x37602 {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nTMEM;
    /* 0x08 */ s32 iTLUT;
    /* 0x0C */ s32 nSizeX;
    ...
    /* 0x26 */ s16 nY1;
    /* 0x28 */ u32 nCodePixel;
} __anon_0x37602; // size = 0x2C

typedef enum __anon_0x378E4 {
    FMP_NONE = -1,
    FMP_PERSPECTIVE = 0,
    FMP_ORTHOGRAPHIC = 1,
} __anon_0x378E4;

typedef struct __anon_0x37968 {
    /* 0x00 */ s32 nCount;
    /* 0x04 */ f32 rScale;
    /* 0x08 */ f32 rAspect;
    ...
    /* 0x20 */ enum __anon_0x378E4 eProjection;
} __anon_0x37968; // size = 0x24
...
typedef struct _GXColor {
    ...
    /* 0x2 */ u8 b;
    /* 0x3 */ u8 a;
} __anon_0x37AFD; // size = 0x4

typedef struct __anon_0x37BB8 {
    ...
    /* 0x000A8 */ struct __anon_0x367D4 viewport;
    /* 0x000B8 */ struct __anon_0x3686E aBuffer[4];
    ...
    /* 0x00130 */ struct __anon_0x36A1F aLight[8];
    /* 0x00310 */ struct __anon_0x36C4F lookAt;
    /* 0x00344 */ s32 nCountVertex;
    /* 0x00348 */ struct __anon_0x36D38 aVertex[80];
    /* 0x00C08 */ struct __anon_0x36F34 TMEM;
    ...
    /* 0x3C340 */ s32 nLastX1;
    /* 0x3C344 */ s32 nLastY1;
    /* 0x3C348 */ struct __anon_0x37602 aTile[8];
...
} __anon_0x37BB8; // size = 0x3D138

// size = 0x4, address = 0x801410E8
struct __anon_0x37BB8* gpFrame;

typedef enum __anon_0x389D8 {
    SPM_NONE = -1,
    SPM_PLAY = 0,
    SPM_RAMPQUEUED = 1,
    SPM_RAMPPLAYED = 2,
...
typedef struct __anon_0x38A44 {
    ...
    /* 0xB4 */ enum __anon_0x389D8 eMode;
    ...
    /* 0xD0 */ s32 nSizeHold;
    /* 0xD4 */ s32 nSizeRamp;
} __anon_0x38A44; // size = 0xD8

// size = 0x4, address = 0x801410E4
struct __anon_0x38A44* gpSound;

// size = 0x10, address = 0x800F3C98
struct _XL_OBJECTTYPE gClassCPU;

// size = 0x10, address = 0x800F5CF8
...
typedef struct __anon_0x38FDA {
    /* 0x0 */ s32 nSize;
    /* 0x4 */ s32 nOffsetRAM;
    /* 0x8 */ s32 nOffsetROM;
    /* 0xC */ s32 (* pCallback)();
} __anon_0x38FDA; // size = 0x10

typedef enum __anon_0x3908B {
    SRT_NONE = -1,
    SRT_MARIO = 0,
    SRT_WAVERACE = 1,
    SRT_MARIOKART = 2,
...
typedef struct __anon_0x3920C {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x3C051 eMode;
    /* 0x10 */ struct __anon_0x38FDA romCopy;
    /* 0x20 */ enum __anon_0x3908B eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x3B499 storageDevice;
    /* 0x74 */ u8 anException[16];
    /* 0x84 */ s32 bJapaneseVersion;
} __anon_0x3920C; // size = 0x88

typedef struct __anon_0x393D4 {
    /* 0x0 */ s32 nOffsetHost;
    /* 0x4 */ s32 nAddressN64;
} __anon_0x393D4; // size = 0x8

typedef struct cpu_callerID {
    /* 0x0 */ s32 N64address;
    /* 0x4 */ s32 GCNaddress;
} __anon_0x3943A; // size = 0x8

typedef struct cpu_function {
    /* 0x00 */ void* pnBase;
    /* 0x04 */ void* pfCode;
    /* 0x08 */ s32 nCountJump;
    /* 0x0C */ struct __anon_0x393D4* aJump;
    /* 0x10 */ s32 nAddress0;
    /* 0x14 */ s32 nAddress1;
...
} __anon_0x394AD; // size = 0x48

typedef union __anon_0x39789 {
    /* 0x0 */ char _0s8;
    /* 0x1 */ char _1s8;
    /* 0x2 */ char _2s8;
    /* 0x3 */ char _3s8;
...
} __anon_0x3A379; // size = 0x84

typedef struct _CPU_ADDRESS {
    /* 0x0 */ s32 nN64;
    /* 0x4 */ s32 nHost;
    /* 0x8 */ struct cpu_function* pFunction;
} __anon_0x3A5BA; // size = 0xC

typedef struct __anon_0x3A66F {
    /* 0x0 */ u32 nAddress;
    /* 0x4 */ u32 nOpcodeOld;
    /* 0x8 */ u32 nOpcodeNew;
} __anon_0x3A66F; // size = 0xC
...
typedef struct _CPU {
    ...
    /* 0x00040 */ union __anon_0x39789 aGPR[32];
    /* 0x00140 */ union __anon_0x39B9D aFPR[32];
    ...
    /* 0x00B64 */ struct __anon_0x3A0AB* apDevice[256];
    ...
    /* 0x11EA8 */ struct __anon_0x3A66F aCodeHack[32];
...
} __anon_0x3ACB9; // size = 0x12090

typedef enum __anon_0x3B350 {
    MIT_NONE = -1,
    MIT_SP = 0,
    MIT_SI = 1,
    MIT_AI = 2,
...
typedef struct __anon_0x3B3CB {
    /* 0x00 */ char* szType;
    /* 0x04 */ u32 nMask;
    /* 0x08 */ enum __anon_0x3B917 eCode;
    /* 0x0C */ enum __anon_0x3B768 eType;
    /* 0x10 */ enum __anon_0x3B350 eTypeMips;
} __anon_0x3B3CB; // size = 0x14

typedef enum __anon_0x3B499 {
    SOT_NONE = -1,
    SOT_CPU = 0,
    SOT_PIF = 1,
    SOT_RAM = 2,
...
struct __anon_0x3920C* gpSystem;

typedef struct __anon_0x3C7D4 {
...
typedef struct CARDFileInfo {
    ...
    /* 0x10 */ u16 iBlock;
    /* 0x12 */ u16 __padding;
} __anon_0x3CAE5; // size = 0x14

typedef struct __anon_0x3CBDD {
    /* 0x000 */ s32 currentGame;
    /* 0x004 */ s32 fileSize;
    /* 0x008 */ char name[33];
    /* 0x02C */ s32 numberOfGames;
    /* 0x030 */ struct __anon_0x3C7D4 game;
...
} __anon_0x3CBDD; // size = 0x35C

typedef enum __anon_0x3CDF3 {
    MC_E_NONE = 0,
    MC_E_BUSY = 1,
    MC_E_WRONGDEVICE = 2,
    MC_E_NOCARD = 3,
...
typedef struct _MCARD {
    /* 0x000 */ struct __anon_0x3CBDD file;
    /* 0x35C */ enum __anon_0x3CDF3 error;
    /* 0x360 */ s32 slot;
...
} __anon_0x3D9DC; // size = 0x3C

typedef enum __anon_0x3DAB4 {
    RLM_NONE = -1,
    RLM_PART = 0,
    RLM_FULL = 1,
    RLM_COUNT_ = 2,
...
typedef struct __anon_0x3DB16 {
    /* 0x0 */ s32 iCache;
    /* 0x4 */ u32 nSize;
    /* 0x8 */ u32 nTickUsed;
    /* 0xC */ char keep;
} __anon_0x3DB16; // size = 0x10

typedef struct __anon_0x3DC2A {
    /* 0x00 */ s32 bWait;
    /* 0x04 */ s32 (* pCallback)();
    /* 0x08 */ u8* pTarget;
    /* 0x0C */ u32 nSize;
    /* 0x10 */ u32 nOffset;
} __anon_0x3DC2A; // size = 0x14

typedef struct __anon_0x3DD0A {
    /* 0x00 */ s32 bWait;
    /* 0x04 */ s32 bDone;
    /* 0x08 */ s32 nResult;
    /* 0x0C */ u8* anData;
    ...
    /* 0x28 */ u32 nSize;
    /* 0x2C */ u32 nSizeRead;
} __anon_0x3DD0A; // size = 0x30

typedef struct __anon_0x3DEF5 {
    /* 0x0 */ s32 nPosition;
    /* 0x4 */ s32 nLineNumber;
} __anon_0x3DEF5; // size = 0x8

typedef struct __anon_0x3DF59 {
    /* 0x0 */ s32 nMode;
    /* 0x4 */ s32 nModeSave;
    /* 0x8 */ struct __anon_0x3DEF5 save;
} __anon_0x3DF59; // size = 0x10

typedef struct __anon_0x3DFDA {
    /* 0x00000 */ void* pHost;
    ...
    /* 0x00214 */ u32 nSize;
    /* 0x00218 */ enum __anon_0x3DAB4 eModeLoad;
    /* 0x0021C */ struct __anon_0x3DB16 aBlock[4096];
    /* 0x1021C */ u32 nTick;
    /* 0x10220 */ u8* pCacheRAM;
    /* 0x10224 */ u8 anBlockCachedRAM[1024];
    /* 0x10624 */ u8 anBlockCachedARAM[2046];
    /* 0x10E24 */ struct __anon_0x3DC2A copy;
    /* 0x10E38 */ struct __anon_0x3DD0A load;
    ...
    /* 0x10EB8 */ struct __anon_0x3DF59 tagFile;
    /* 0x10EC8 */ u32 nChecksum;
    /* 0x10ECC */ struct DVDFileInfo fileInfo;
    /* 0x10F08 */ s32 offsetToRom;
} __anon_0x3DFDA; // size = 0x10F0C

typedef enum __anon_0x3E3B5 {
    CT_NONE = 0,
    CT_CONTROLLER = 1,
...
typedef struct __anon_0x3E48E {
    /* 0x00 */ void* pROM;
    /* 0x04 */ void* pRAM;
    /* 0x08 */ void* pHost;
    /* 0x0C */ u16 controllerType[5];
    /* 0x16 */ char controllerStatus[5];
    /* 0x1C */ enum __anon_0x3E3B5 eControllerType[5];
} __anon_0x3E48E; // size = 0x30

// Range: 0x80030118 -> 0x8003050C
static s32 systemSetupGameRAM(struct __anon_0x3920C* pSystem) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r27
    ...
    s32 nSizeExtra; // r3
    struct __anon_0x3DFDA* pROM; // r29
    u32 nCode; // r28
    u32 iCode; // r1+0x8
...
// Range: 0x8002F7A8 -> 0x80030118
s32 systemGetInitialConfiguration(struct __anon_0x3DFDA* pROM, s32 index) {
    // Parameters
    // struct __anon_0x3DFDA* pROM; // r23
    // s32 index; // r1+0x10
...
// Range: 0x8002CDA8 -> 0x8002F7A8
static s32 systemSetupGameALL(struct __anon_0x3920C* pSystem) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r18
    ...
    struct __anon_0x3DFDA* pROM; // r19
    struct __anon_0x3E48E* pPIF; // r27
...
// Erased
static s32 systemClearExceptions(struct __anon_0x3920C* pSystem) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r1+0x0

    // Local variables
    s32 iException; // r1+0x0
}

// Range: 0x8002CBCC -> 0x8002CDA8
static s32 systemGetException(enum __anon_0x3B768 eType, struct __anon_0x3B3CB* pException) {
    // Parameters
    // enum __anon_0x3B768 eType; // r1+0x4
    // struct __anon_0x3B3CB* pException; // r1+0x8
}

// Range: 0x8002CBBC -> 0x8002CBCC
static s32 systemGet8(char* pData) {
    // Parameters
    // char* pData; // r1+0x8
}

// Range: 0x8002CBAC -> 0x8002CBBC
static s32 systemGet16(s16* pData) {
    // Parameters
    // s16* pData; // r1+0x8
}

// Range: 0x8002CB9C -> 0x8002CBAC
static s32 systemGet32(s32* pData) {
    // Parameters
    // s32* pData; // r1+0x8
}

// Range: 0x8002CB88 -> 0x8002CB9C
static s32 systemGet64(s64* pData) {
    // Parameters
    // s64* pData; // r1+0x8
}

// Range: 0x8002CB80 -> 0x8002CB88
static s32 systemPut8() {}

// Range: 0x8002CB78 -> 0x8002CB80
static s32 systemPut16() {}

// Range: 0x8002CB70 -> 0x8002CB78
static s32 systemPut32() {}

// Range: 0x8002CB68 -> 0x8002CB70
static s32 systemPut64() {}

// Range: 0x8002CA30 -> 0x8002CB68
...
// Range: 0x8002C93C -> 0x8002CA30
s32 systemCopyROM(struct __anon_0x3920C* pSystem, s32 nOffsetRAM, s32 nOffsetROM, s32 nSize, s32 (* pCallback)()) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r29
    // s32 nOffsetRAM; // r4
    // s32 nOffsetROM; // r30
    // s32 nSize; // r1+0x14
    // s32 (* pCallback)(); // r31
...
// Erased
static s32 systemSetBreak(struct __anon_0x3920C* pSystem, s64 nAddress) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r1+0x0
    // s64 nAddress; // r1+0x8
}
...
// Erased
static s32 systemClearBreak(struct __anon_0x3920C* pSystem) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r1+0x0
}

// Range: 0x8002C8CC -> 0x8002C93C
s32 systemSetMode(struct __anon_0x3920C* pSystem, enum __anon_0x3C051 eMode) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r30
    // enum __anon_0x3C051 eMode; // r31

    // References
    // -> struct _XL_OBJECTTYPE gClassSystem;
}

// Range: 0x8002C864 -> 0x8002C8CC
s32 systemGetMode(struct __anon_0x3920C* pSystem, enum __anon_0x3C051* peMode) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r30
    // enum __anon_0x3C051* peMode; // r31

    // References
    // -> struct _XL_OBJECTTYPE gClassSystem;
}

// Range: 0x8002C778 -> 0x8002C864
s32 systemSetStorageDevice(struct __anon_0x3920C* pSystem, enum __anon_0x3B499 storageDevice) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r30
    // enum __anon_0x3B499 storageDevice; // r31
...
// Range: 0x8002C768 -> 0x8002C778
s32 systemGetStorageDevice(struct __anon_0x3920C* pSystem, enum __anon_0x3B499* pStorageDevice) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r1+0x0
    // enum __anon_0x3B499* pStorageDevice; // r1+0x4
}

// Range: 0x8002C5B0 -> 0x8002C768
s32 systemReset(struct __anon_0x3920C* pSystem) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r29
    ...
    s64 nPC; // r1+0x10
    s32 nOffsetRAM; // r4
    enum __anon_0x3B499 eObject; // r30
}

// Range: 0x8002C4B4 -> 0x8002C5B0
s32 systemExecute(struct __anon_0x3920C* pSystem, s32 nCount) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r31
    // s32 nCount; // r4
...
// Range: 0x8002C35C -> 0x8002C4B4
s32 systemCheckInterrupts(struct __anon_0x3920C* pSystem) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r25
    ...
    s32 bUsed; // r28
    s32 bDone; // r27
    struct __anon_0x3B3CB exception; // r1+0xC
    enum __anon_0x3B917 eCodeFinal; // r26
}

// Range: 0x8002C324 -> 0x8002C35C
s32 systemExceptionPending(struct __anon_0x3920C* pSystem, enum __anon_0x3B768 eType) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r1+0x0
    // enum __anon_0x3B768 eType; // r1+0x4
}

// Range: 0x8002BA4C -> 0x8002C324
s32 systemEvent(struct __anon_0x3920C* pSystem, s32 nEvent, void* pArgument) {
    // Parameters
    // struct __anon_0x3920C* pSystem; // r31
    // s32 nEvent; // r1+0xC
    // void* pArgument; // r26
    ...
    // Local variables
    struct _CPU* pCPU; // r30
    struct __anon_0x3B3CB exception; // r1+0x1C
    enum __anon_0x3B499 eObject; // r1+0x8
    enum __anon_0x3B499 storageDevice; // r1+0x8
