/*
    ...
    Language: C89
    Code range: 0x80035FE0 -> 0x80067B44
*/
...
s32 cpuMakeFunction(struct _CPU* pCPU, struct cpu_function** ppFunction, s32 nAddressN64) {
    ...
    struct __anon_0x40096 aJump[1024]; // r1+0x18
...
static s32 cpuExecuteUpdate(struct _CPU* pCPU, s32* pnAddressGCN, u32 nCount) {
    ...
    // Local variables
    enum __anon_0x46BB0 eModeUpdate; // r4
    struct __anon_0x3FD32* pSystem; // r31
    s32 nDelta; // r1+0x8
    u32 nCounter; // r1+0x8
    u32 nCompare; // r1+0x8
...
static s32 cpuExecuteOpcode(struct _CPU* pCPU, s32 nCount, s32 nAddressN64, s32 nAddressGCN) {
    ...
    u32 nOpcode; // r30
    u32* opcode; // r1+0x6C
    struct __anon_0x40D6D** apDevice; // r28
    u8* aiDevice; // r29
    s32 reg; // r1+0x8
    s32 value; // r1+0x8
    s32 iEntry; // r4
...
static s32 cpuExecuteIdle(struct _CPU* pCPU, s32 nCount, s32 nAddressN64, s32 nAddressGCN) {
    ...
    // Local variables
    struct __anon_0x46705* pROM; // r30
}

// Range: 0x80038B28 -> 0x80038BF8
