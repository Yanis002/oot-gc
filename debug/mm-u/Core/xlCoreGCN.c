...
// size = 0x8081, address = 0x800D8B00
u8 gTgPcTPL[32897];

// size = 0x4, address = 0x80141060
static s32 gnCountArgument;

// size = 0x4, address = 0x80141064
static char** gaszArgument;

// size = 0x4, address = 0x80141068
...
// size = 0x3C, address = 0x800FDF80
static struct _GXRenderModeObj rmodeobj;

// size = 0x4, address = 0x80141070
static void* gpHeap;

// size = 0x4, address = 0x80141074
static void* gArenaHi;

// size = 0x4, address = 0x80141078
