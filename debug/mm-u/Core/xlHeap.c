...
// size = 0x4, address = 0x80141088
static u32* gpHeap;

// size = 0x4, address = 0x8014108C
static u32* gpHeapBlockFirst;

// size = 0x4, address = 0x80141090
static u32* gpHeapBlockLast;

// size = 0x4, address = 0x80141094
static s32 gnHeapTakeCount;

// size = 0x4, address = 0x80141098
static s32 gnHeapFreeCount;

// size = 0x4, address = 0x8014109C
static s32 gnHeapTakeCacheCount;

// size = 0x580, address = 0x800FE050
static u32* gapHeapBlockCache[11][32];

// size = 0x4, address = 0x801410A0
s32 gnSizeHeap;
