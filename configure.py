...
config.libs = [
    EmulatorLib(
        ...
        [
            ...
            Object(LinkedFor("mq-e", "ce-e", "mm-j", "mm-u"), "emulator/xlText.c"),
            Object(Linked, "emulator/xlList.c"),
            Object(Linked, "emulator/xlHeap.c"),
            Object(LinkedFor("mq-e", "ce-e", "mm-j", "mm-u"), "emulator/xlFile.c"),
            ...
            Object(LinkedFor(*OOT_VERSIONS, "mm-j"), "emulator/library.c"),
    ...
    DolphinLib(
        ...
        [
            ...
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u"), "dolphin/gx/GXLight.c"),
